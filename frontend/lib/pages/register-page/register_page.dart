...
import 'package:ticket_booking_app/pages/register-page/register_page_logic.dart';

class RegisterPage extends FPage<RegisterPageLogic> {
  FPageTransitionHolder? transitionHolder;

  RegisterPage(this.transitionHolder);

  @override
  void initialize() {
    setLogic(RegisterPageLogic(transitionHolder));
  }
