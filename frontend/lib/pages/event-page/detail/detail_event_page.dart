...
import 'package:ticket_booking_app/pages/event-page/detail/detail_event_page_logic.dart';

class DetailEventPage extends FPage<DetailEventPageLogic> {
  FPageTransitionHolder? transitionHolder;

  DetailEventPage(this.transitionHolder);

  @override
  void initialize() {
    setLogic(DetailEventPageLogic(transitionHolder));
  }
